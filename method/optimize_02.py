# #!/usr/bin/python3
# # -*- coding: utf-8 -*-
# # @Time    : 2023/12/7 10:39
# # @Author  : YOURNAME
# # @FileName: optimize_02.py
# # @Software: PyCharm
#
# import numpy as np
#
...
#
#     denominators = 4 * alpha * fl_mat @ f_mat.T @ fl_mat + 2 * bl_mat.T @ wl_mat
...
#
#
# def update_f(w_list, f_list, f_mat, z_mat, para_list, my_eps=1e-10):
#     alpha = para_list['alpha']
#     beta = para_list['beta']
...
#
#
# def update_z(f_mat, z_mat, my_eps=1e-10):
#     # Z: node_num * node_num
...
#         loss3 += alpha * (np.linalg.norm(f_mat.T @ f_mat - fl_mat.T @ fl_mat) ** 2)
#
#         sim_mat, _, diag_k_mat = calculate_sim_mat(wl_mat, fl_mat, f_mat, para_list)
